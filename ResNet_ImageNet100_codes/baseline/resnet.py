    ...
    def __init__(self, in_planes, planes, stride=1, option='B'):
        ...
        if stride != 1 or in_planes != planes:
            if option == 'M':
                ...
                #self.shortcut = F.pad(x, (0, 0, 0, 0, self.planes//4, self.planes//4), "constant", 0)
                #self.shortcut = short_func(planes)
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=100):
        ...
        self.layer5 = self._make_layer(block, 128, num_blocks[2], stride=2)
    ...
    def forward(self, x):
        ...
        #out = F.avg_pool2d(out, out.size()[4])
