...
class ChannelGate(nn.Module):
    def __init__(self, gate_channels, reduction_ratio=2, pool_types=['avg', 'max']):
        ...
        self.mlp = nn.Sequential(
            ...
            nn.Conv2d(gate_channels, gate_channels, kernel_size=(1, 1), stride=(1, 1)),
            ...
            # nn.Hardtanh(),
            # #nn.Linear(gate_channels // reduction_ratio, gate_channels)
            # nn.Conv2d(gate_channels // reduction_ratio, gate_channels, kernel_size=1, stride=1),
        ...
        self.fuse = nn.Sequential(
            ...
            nn.Conv2d(gate_channels*2, gate_channels, kernel_size=(1, 1), stride=(1, 1)),
...
class CBAM(nn.Module):
    def __init__(self, gate_channels, reduction_ratio= 1, pool_types=['avg', 'max'], no_spatial=True):
